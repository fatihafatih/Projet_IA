...
<div class="stats-grid fade-up">
  <div class="stat-card">
    <div class="stat-icon">
      <svg width="18" height="18" fill="none" stroke="#F5B800" stroke-width="2.2" viewBox="0 0 24 24"><path d="M14.7 6.3a1 1 0 0 0 0 1.4l1.6 1.6a1 1 0 0 0 1.4 0l3.77-3.77a6 6 0 0 1-7.94 7.94l-6.91 6.91a2.12 2.12 0 0 1-3-3l6.91-6.91a6 6 0 0 1 7.94-7.94l-3.76 3.76z"/></svg>
    </div>
  ...
  <div class="stat-card">
    <div class="stat-icon">
      <svg width="18" height="18" fill="none" stroke="#F5B800" stroke-width="2.2" viewBox="0 0 24 24"><path d="M20.84 4.61a5.5 5.5 0 0 0-7.78 0L12 5.67l-1.06-1.06a5.5 5.5 0 0 0-7.78 7.78l1.06 1.06L12 21.23l7.78-7.78 1.06-1.06a5.5 5.5 0 0 0 0-7.78z"/></svg>
    </div>
  ...
  <div class="stat-card">
    <div class="stat-icon">
      <svg width="18" height="18" fill="none" stroke="#F5B800" stroke-width="2.2" viewBox="0 0 24 24"><path d="M14 2H6a2 2 0 0 0-2 2v16a2 2 0 0 0 2 2h12a2 2 0 0 0 2-2V8z"/><polyline points="14 2 14 8 20 8"/></svg>
    </div>
  ...
  <div class="stat-card">
    <div class="stat-icon">
      <svg width="18" height="18" fill="none" stroke="#F5B800" stroke-width="2.2" viewBox="0 0 24 24"><path d="M18 8A6 6 0 0 0 6 8c0 7-3 9-3 9h18s-3-2-3-9"/><path d="M13.73 21a2 2 0 0 1-3.46 0"/></svg>
    </div>
...
<div style="display:grid;grid-template-columns:1fr 340px;gap:24px;">
  ...
  <div class="card fade-up-2">
    ...
    <div style="display:flex;align-items:flex-start;gap:14px;padding:14px 24px;border-bottom:1px solid #F9FAFB;">
      <div style="width:36px;height:36px;border-radius:10px;background:#FFFBEB;display:flex;align-items:center;justify-content:center;flex-shrink:0;font-size:16px;">
        <?= $icon ?>
      </div>
      <div style="flex:1;">
...
<?php endforeach; ?>
  ...
  <div class="card fade-up-3" style="align-self:start;">
    <div class="card-header">
      ...
      <a href="/Projet_IA/php/user/demandes.php" style="font-size:12px;color:var(--gold);font-weight:700;text-decoration:none;">Voir tout →</a>
    </div>
    <div class="card-body" style="padding:0;">
      ...
      <?php else: ?>
        <?php foreach ($demandes as $d): ?>
          ...
          ?>
        <div style="padding:14px 20px;border-bottom:1px solid #F9FAFB;display:flex;align-items:center;justify-content:space-between;gap:12px;">
          <div>
